...
'grid2': [[0,0,0,6,8,0,0,1,9],[0,0,0,4,7,0,5,0,8],[0,8,0,0,2,0,6,4,7],[0,6,0,3,4,2,1,9,0],[9,0,0,6,8,0,0,5,0],[0,0,4,0,0,0,8,3,0],[0,0,0,0,0,6,0,0,3],[7,2,0,0,0,5,8,9,1],[4,0,3,0,1,0,5,0,0]]}
...
'grid1': [[2,5,0,3,0,9,0,0,1],[0,0,3,0,0,0,0,0,6],[0,9,1,7,2,0,3,0,0],[0,0,0,0,1,0,6,0,3],[0,6,8,0,4,0,0,0,0],[0,0,3,0,0,0,0,5,0],[1,3,2,0,0,0,7,6,4],[0,0,0,0,0,4,0,1,0],[0,7,0,0,6,0,0,0,0]]}

hard = {'grid0':[[9,0,0,0,0,0,0,7,0],[0,1,0,0,6,0,9,0,8],[0,7,0,0,2,4,0,0,0],[0,0,6,2,1,8,0,5,3],[0,0,0,0,0,0,2,0,4],[0,0,0,0,0,0,6,0,0],[0,0,0,0,0,0,5,0,0],[5,4,9,0,0,0,0,0,0],[0,0,0,7,0,2,0,8,0]],
'grid1': [[0,0,0,8,0,1,6,0,0],[6,0,0,0,0,7,0,0,4],[0,2,0,9,0,0,1,0,0],[0,0,5,0,2,8,0,0,0],[0,0,8,5,6,0,0,0,0],[0,0,0,4,0,3,0,8,0],[0,0,0,0,0,0,1,5,0],[0,9,0,7,0,0,0,0,0],[0,0,7,0,1,0,0,0,4]]}
...
def get_grid(level):
	try:
		...
		#if(level.upper()=='HARD'):
		#	return(hard[str("grid"+str(random.randint(0, (len(hard)-1))))])
		if(level.upper()=='HARD'):
